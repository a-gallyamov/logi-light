...
export const LoadingOrError = ({ error }: Properties) => {
  if (error) {
    return (
      <div className={cls.errBoundary}>
        <Result title="Ошибка" status="warning" extra={extraButtons} subTitle="Произошла непредвиненная ошибка приложения">
  ...
  return (
    <Flex align="center" justify="center" style={{ position: 'fixed', width: '100%', height: '100%' }}>
